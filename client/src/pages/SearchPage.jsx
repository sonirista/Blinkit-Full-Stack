    ...
    <section className='bg-white'>
      <div className='container mx-auto p-4'>
        ...
        <InfiniteScroll dataLength={data.length} hasMore={true} next={handleFetchMore}>
          <div className='grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 py-4 gap-4'>
...

        {
              ...
              !data[0] && !loading && (
                <div className=' flex flex-col justify-center items-center w-fit mx-auto '>
                  <img src={noData} className='w-full h-full max-w-xs max-h-xs block'/>
