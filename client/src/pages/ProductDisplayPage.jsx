    ...
    <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
      ...
      <div className='p-4 lg:pl-7 text-base lg:text-lg'>
        <p className='bg-green-300 w-fit px-2 rounded-full'>10 Min</p>
            ...
            <div className='border border-green-500 px-4 py-4 rounded bg-green-50 w-fit'>
          ...
          <h2 className='font-semibold'>My Shop from Blinkyet? </h2>
          <div>
            <div className='flex items-center gap-4 my-4'>
              <img src={image1}
               ...
               <div className='text-sm'>
                ...
                <p>Get your delivered to your doorstep at the earliest from dark stores near you..</p>
               </div>
            </div>
            <div className='flex items-center gap-4 my-4'>
              <img src={image2}
            ...
            <div className='flex items-center gap-4 my-4'>
              <img src={image3}
               ...
               <div className='text-sm'>
                ...
                <p>Choose from 5000+ products across food personal care, household & other categpries</p>
               </div>
            </div>

          </div>
          {/* only mobile */}
          <div className='my-4 grid gap-3'></div>
      </div>
    </section>
  )
}
