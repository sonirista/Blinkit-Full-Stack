...
const ProductListPage = () => {
  ...
  return (
    <section className='min-h-screen sticky top-24 lg:top-20'>
      <div className='w-full sticky grid grid-cols-[90px_1fr] md:grid-cols-[200px_1fr] lg:grid-cols-[280px_1fr]'>
        ...
        <div className='min-h-[88vh] max-h-[88vh] overflow-y-scroll lg:py-4 grid gap-1 shadow-md scrollbarCustom bg-white py-2 '>
          {
            DisplaySubCategory.map((s, index) => {
              ...
              return (
                <Link to={link}
                  key={s._id}
                  className={`w-full p-2 lg:flex items-center lg:w-full lg:h-16 box-border lg:gap-4 border-b hover:bg-green-300 cursor-pointer ${subCategoryId?.toString().trim() === s._id?.toString().trim() ? "bg-green-100" : "bg-white"
                    }`}
                >
