...
const EditProductAdmin = ({ close,data : propsData }) => {
    ...
    return (
        <section className='fixed top-0 right-0 left-0 bottom-0 bg-black/60 z-50 p-4'>
                ...
                <section >
                    ...
                    <div className='grid p-3'>
                        <form className='grid gap-4' onSubmit={handleSubmit} >
                            ...
                            <button className='bg-yellow-300 hover:bg-yellow-400 py-2 rounded font-semibold'>Update Product</button>
                        </form>
                    </div>
                    {
                        viewImageUrl && (
