                ...
                <form className='my-3 grid gap-3' onSubmit={handleSubmitSubCategory}>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <input
                            ...
                            className='p-3 bg-blue-50 border outline-none focus-within:border-yellow-300 rounded' />
                    </div>
                    <div className='grid gap-1'>
                        <p> Image</p>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='border focus-within:border-amber-300 rounded'>
                            ...
                            {/* select category */}
                            <select
                                className='w-full p-2 bg-transparent outline-none border' onChange={(e)=>{
                    ...
                    <button className={`px-4 py-2 border font-semibold 
                      ${subCategoryData?.name && subCategoryData.image && subCategoryData?.category[0] ? "bg-yellow-300 hover:bg-yellow-200" :"bg-gray-200"}
